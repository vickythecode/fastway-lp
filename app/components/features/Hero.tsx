...
export default function Hero() {
  return (
    // section remains relative so elements inside can be absolute
    <section className="relative w-full max-w-7xl mx-auto px-6 pt-20 pb-32 min-h-[85vh] flex flex-col justify-center z-10" >
      
      {/* --- CSS GLOW ORBS REMOVED --- */}
    ...
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hidden sm:block">
      <path d="M5 12h14M12 5l7 7-7 7"/>
        ...
        <div className="relative h-[600px] w-full hidden lg:block">
          {/* Note: Update the src paths below with your actual exported Figma images */}
          ...
          <div className="absolute top-44 left-0 w-[600px] z-10 transform hover:-translate-y-2 transition-transform duration-500">
             {/* Replace with Transfer Card Image */}
             <Image src="/images/card2.png" alt="Transfer Detail" width={500} height={200} className="w-full h-auto drop-shadow-2xl" />
          </div>

          {/* Small Metric Cards (Target Layout) */}
{/* Card 1: 0.01% Failure Rate - Positioned higher and further left */}
...
{/* Card 2: 95% Faster Processing - Positioned lower and further right */}
<div className="absolute bottom-[-100] right-36 z-20 transform hover:-translate-y-2 transition-transform duration-500 drop-shadow-2xl">
  ...
  />
      ...
      <div className="pt-30">
        ...
        {/* The container keeps the grayscale hover effect for all logos */}
        <div className="flex flex-wrap items-center gap-8 md:gap-12 opacity-70 grayscale hover:grayscale-0 transition-all duration-300">
          ...
          <Image 
            src="/images/Clogo1.png" /* Replace with your actual file extension */
            alt="Slack" 
            width={100} 
            height={100} 
            className="object-contain h-auto  h-[100px]" 
          />
